...
function nextChart(nome, id, time, pesq){
    ...
    document.getElementById("teste").innerHTML = "<a class='s-link' onclick='consulta("+id+")' rel='noopener noreferrer'>Adicionar Consulta</a><a href='report/report-sisped.php?id="+id+"&p="+nome+"&time="+time+"&pesq="+pesq+"' target='_blank' class='s-link' rel='noopener noreferrer'>Relatorio Padrão</a>";
