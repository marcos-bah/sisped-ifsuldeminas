...
function nextChart(nome, id, time, pesq){
    ...
    document.getElementById("teste").innerHTML = "<a class='s-link' onclick='modal("+id+")' rel='noopener noreferrer'>Adicionar Consulta</a><a href='report/index.php?q="+id+"' class='s-link' target='_blank' rel='noopener noreferrer'>Relatorio Padrão</a>";
